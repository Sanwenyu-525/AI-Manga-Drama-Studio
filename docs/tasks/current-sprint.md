...
|---:|---|---|---|---|---|---|
| 1 | P1-E1-T02 | 建立数据库不变量、原子 revision 与安全重排 | P0 | L | P1-E1-T01 事务决策（已定：见 roadmap §P1-E1-T01 Design Decision） | Blocked by dependency |
| 2 | P1-E2-T02 | 实现 Generation 状态机、原子认领与崩溃恢复 | P0 | L | P1-E1-T02 | Blocked by dependency |
| 3 | P1-E6-T01 | 建立风险驱动测试基线与最小 CI | P0 | L | 测试框架可先行；风险用例随任务落地 | Ready |
