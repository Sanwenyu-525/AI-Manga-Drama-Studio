...
|---:|---|---|---|---|---|---|
| 2 | P1-E4-T01 | 修复路由冲突并统一错误/请求契约 | P0 | M | 无 | Ready |
| 3 | P1-E3-T01 | 强制 Agent Project Ownership 与 Run-local Context | P0 | M | 无 | Ready |
| 4 | P1-E3-T02 | 实现协作式 Agent Cancel 与真实执行报告 | P0 | M | P1-E3-T01 | Blocked by dependency |
| 5 | P1-E2-T01 | 修复真实 ComfyUI workflow 与 Provider 选择 | P0 | M | 无 | Ready |
| 6 | P1-E1-T02 | 建立数据库不变量、原子 revision 与安全重排 | P0 | L | P1-E1-T01 事务决策（已定：见 roadmap §P1-E1-T01 Design Decision） | Blocked by dependency |
| 7 | P1-E2-T02 | 实现 Generation 状态机、原子认领与崩溃恢复 | P0 | L | P1-E1-T02 | Blocked by dependency |
| 8 | P1-E6-T01 | 建立风险驱动测试基线与最小 CI | P0 | L | 测试框架可先行；风险用例随任务落地 | Ready |
