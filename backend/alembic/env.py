"""Alembic environment — wired to Studio settings + metadata.

sqlalchemy.url comes from app.core.config (STUDIO_DATA_DIR / data_dir), so the
same DB used by the app is migrated.
"""
...
from app.db import models  # noqa: F401 — import all models so metadata is complete
